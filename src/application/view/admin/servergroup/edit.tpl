...
<div>
  <ul class="breadcrumb">
	...
	<li><a href="/servergroup/" class="load-page">管理</a> <span class="divider">/</span></li>
	<li>编辑</li>
  </ul>
</div>
...
<div id="system-info" class="row-fluid">
  <div class="box span12">
	...
	<div class="box-content">
	     ...
	     <form  class="form-horizontal" action="/servergroup/edit/?action=save" method="post">
		<fieldset>
		  ...
		  <div class="form-actions">
			...
			<button onclick="window.location.href='/servergroup/'" type="reset" class="btn">返回</button>
		  </div>
		</fieldset>
	   </form>
	</div>
